	...
	})()(
		{
				...
				function (e, t, n) {
					...
					function o(e) {
						...
						for (n = 0; n < f; n += 4)
							(t =
								(u[e.charCodeAt(n)] << 18) |
								(u[e.charCodeAt(n + 1)] << 12) |
								(u[e.charCodeAt(n + 2)] << 6) |
								u[e.charCodeAt(n + 3)]),
								(l[c++] = 255 & (t >> 16)),
								(l[c++] = 255 & (t >> 8)),
								(l[c++] = 255 & t);
						return (
							2 === s &&
								((t = (u[e.charCodeAt(n)] << 2) | (u[e.charCodeAt(n + 1)] >> 4)),
								(l[c++] = 255 & t)),
							1 === s &&
								((t =
									(u[e.charCodeAt(n)] << 10) |
									(u[e.charCodeAt(n + 1)] << 4) |
									(u[e.charCodeAt(n + 2)] >> 2)),
								(l[c++] = 255 & (t >> 8)),
								(l[c++] = 255 & t)),
							l
						);
					...
					function l(e) {
						for (var t, n = e.length, r = n % 3, a = [], o = 16383, d = 0, l = n - r; d < l; d += o)
							a.push(s(e, d, d + o > l ? l : d + o));
						return (
							1 === r
								? ((t = e[n - 1]), a.push(c[t >> 2] + c[63 & (t << 4)] + '=='))
								: 2 === r &&
								  ((t = (e[n - 2] << 8) + e[n - 1]),
								  a.push(c[t >> 10] + c[63 & (t >> 4)] + c[63 & (t << 2)] + '=')),
							a.join('')
						);
					}
					...
					for (
						var c = [],
							u = [],
							p = 'undefined' == typeof Uint8Array ? Array : Uint8Array,
				...
				function (e, t, n) {
					(function () {
						(function () {
							...
							function f(e, t) {
								if ((('string' != typeof t || '' === t) && (t = 'utf8'), !s.isEncoding(t)))
							...
							function g(e) {
								for (var t = 0 > e.length ? 0 : 0 | m(e.length), n = d(t), r = 0; r < t; r += 1)
									n[r] = 255 & e[r];
								return n;
							}
							function _(e, t, n) {
							...
							function R(e, t, n, r, a) {
								...
								if (('string' == typeof t && (t = s.from(t, r)), s.isBuffer(t)))
									return 0 === t.length ? -1 : E(e, t, n, r, a);
								if ('number' == typeof t)
									return (
										(t &= 255),
								...
								for (var r = [], a = t; a < n; ) {
									...
									if (a + l <= n) {
										...
										1 === l
											...
											: 2 === l
											? ((c = e[a + 1]),
											  128 == (192 & c) && ((f = ((31 & d) << 6) | (63 & c)), 127 < f && (s = f)))
											: 3 === l
											? ((c = e[a + 1]),
											  (u = e[a + 2]),
											  128 == (192 & c) &&
													128 == (192 & u) &&
													((f = ((15 & d) << 12) | ((63 & c) << 6) | (63 & u)),
													2047 < f && (55296 > f || 57343 < f) && (s = f)))
											: 4 === l
											? ((c = e[a + 1]),
											  (u = e[a + 2]),
											  (p = e[a + 3]),
											  128 == (192 & c) &&
													128 == (192 & u) &&
													128 == (192 & p) &&
													((f = ((15 & d) << 18) | ((63 & c) << 12) | ((63 & u) << 6) | (63 & p)),
													65535 < f && 1114112 > f && (s = f)))
											: void 0;
									}
									null === s
										? ((s = 65533), (l = 1))
										: 65535 < s &&
										  ((s -= 65536), r.push(55296 | (1023 & (s >>> 10))), (s = 56320 | (1023 & s))),
										r.push(s),
										(a += l);
								}
								return N(r);
							...
							function M(e, n, r) {
								for (var a = e.slice(n, r), o = '', d = 0; d < a.length; d += 2)
									o += t(a[d] + 256 * a[d + 1]);
								return o;
							}
							function O(e, t, n) {
							...
							function U(e, t, n, r, a) {
								return (
									(t = +t),
									(n >>>= 0),
									a || B(e, t, n, 4, 34028234663852886e22, -34028234663852886e22),
							...
							function j(e, t, n, r, a) {
								return (
									(t = +t),
									(n >>>= 0),
									a || B(e, t, n, 8, 17976931348623157e292, -17976931348623157e292),
							...
							function V(e, t) {
								for (var n, r, a, o = [], d = 0; d < e.length && !(0 > (t -= 2)); ++d)
									(n = e.charCodeAt(d)), (r = n >> 8), (a = n % 256), o.push(a), o.push(r);
								return o;
							}
							function z(e) {
							...
							(n.kMaxLength = 2147483647),
								...
								(s.compare = function (e, t) {
									...
									if (e === t) return 0;
									for (var n = e.length, r = t.length, d = 0, l = o(n, r); d < l; ++d)
										if (e[d] !== t[d]) {
											(n = e[d]), (r = t[d]);
											break;
										}
								...
								(s.prototype.compare = function (e, t, n, r, a) {
									if ((K(e, Uint8Array) && (e = s.from(e, e.offset, e.byteLength)), !s.isBuffer(e)))
										throw new TypeError(
									...
									if (
										...
										0 > t || n > e.length || 0 > r || a > this.length)
									)
							...
							(s.prototype.slice = function (e, t) {
								...
								(s.prototype.writeUInt8 = function (e, t, n) {
									return (
										(e = +e), (t >>>= 0), n || F(this, e, t, 1, 255, 0), (this[t] = 255 & e), t + 1
									);
								}),
			...
			6: [
				function (e, t) {
					...
					function n(e, t) {
						for (const n in t)
							Object.defineProperty(e, n, { value: t[n], enumerable: !0, configurable: !0 });
						return e;
					}
				...
				function (e, t) {
						...
						if (
							...
							var c = new Error(
								'Possible EventEmitter memory leak detected. ' +
									l.length +
									' ' +
									(t + ' listeners added. Use emitter.setMaxListeners() to increase limit')
							);
					...
					(t.exports = r),
						(t.exports.once = function (e, t) {
							return new Promise(function (n, r) {
								...
								_(e, t, o, { once: !0 }), 'error' !== t && g(e, a, { once: !0 });
							});
						}),
						(r.EventEmitter = r),
					...
					Object.defineProperty(r, 'defaultMaxListeners', {
						...
						(r.prototype.emit = function (e) {
							...
							else for (var l = s.length, c = u(s, l), n = 0; n < l; ++n) b(c[n], this, t);
							return !0;
						}),
					...
					/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */ (o.read =
						function (t, n, a, o, l) {
							var c,
								...
								d = t[n + h];
							for (
								h += b, c = d & ((1 << -_) - 1), d >>= -_, _ += p;
								0 < _;
								c = 256 * c + t[n + h], h += b, _ -= 8
							);
							for (
								u = c & ((1 << -_) - 1), c >>= -_, _ += o;
								0 < _;
								u = 256 * u + t[n + h], h += b, _ -= 8
							);
							if (0 === c) c = 1 - g;
							else {
							...
							for (
								o = n(o),
									isNaN(o) || o === 1 / 0
										...
										: ((h = t(_(o) / g)),
										  1 > o * (y = r(2, -h)) && (h--, (y *= 2)),
										  (o += 1 <= h + E ? w / y : w * r(2, 1 - E)),
										  2 <= o * y && (h++, (y /= 2)),
										  h + E >= R
												? ((b = 0), (h = R))
												: 1 <= h + E
												? ((b = (o * y - 1) * r(2, p)), (h += E))
												: ((b = o * r(2, E - 1) * r(2, p)), (h = 0)));
								8 <= p;
								a[l + S] = 255 & b, S += T, b /= 256, p -= 8
							);
					...
					function a(e) {
						if (((e += ''), !(100 < e.length))) {
							...
							if (t) {
								...
								return 'years' === n || 'year' === n || 'yrs' === n || 'yr' === n || 'y' === n
									? 31557600000 * r
									: 'weeks' === n || 'week' === n || 'w' === n
									? 604800000 * r
									: 'days' === n || 'day' === n || 'd' === n
									? 86400000 * r
									: 'hours' === n || 'hour' === n || 'hrs' === n || 'hr' === n || 'h' === n
									? 3600000 * r
									: 'minutes' === n || 'minute' === n || 'mins' === n || 'min' === n || 'm' === n
									? 60000 * r
									: 'seconds' === n || 'second' === n || 'secs' === n || 'sec' === n || 's' === n
									? 1000 * r
									: 'milliseconds' === n ||
									  'millisecond' === n ||
									  'msecs' === n ||
						...
						(function () {
							...
							t.exports =
								'function' == typeof queueMicrotask
									? queueMicrotask.bind('undefined' == typeof window ? e : window)
									: (e) =>
			...
			15: [
				function (e, t) {
					...
					function a(e, t) {
						if (Array.isArray(e)) {
							...
							return (
								...
								2 < n
									? 'one of '.concat(t, ' ').concat(e.slice(0, n - 1).join(', '), ', or ') +
									  e[n - 1]
									: 2 === n
					...
					function i(e, t, n) {
						return (
							(void 0 === n || n > e.length) && (n = e.length), e.substring(n - t.length, n) === t
						);
					}
					function d(e, t, n) {
						return (
							'number' != typeof n && (n = 0), !(n + t.length > e.length) && -1 !== e.indexOf(t, n)
						);
					}
					var s = {};
					r(
					...
					(function (n) {
						(function () {
							...
							for (var l, c = i(s.prototype), u = 0; u < c.length; u++)
								(l = c[u]), r.prototype[l] || (r.prototype[l] = s.prototype[l]);
						...
						(function () {
							...
							function d(t, n, r) {
								(A = A || e('./_stream_duplex')),
									(t = t || {}),
									'boolean' != typeof r && (r = n instanceof A),
							...
							function l(e, t, n, r, o) {
								...
								if (null === t) (i.reading = !1), g(e, i);
									...
									if ((o || (d = u(i, t)), d)) X(e, d);
										...
										i.endEmitted ? X(e, new K()) : c(e, i, t, !0);
									else if (i.ended) X(e, new z());
									else {
										if (i.destroyed) return !1;
										(i.reading = !1),
											i.decoder && !n
												? ((t = i.decoder.write(t)),
												  i.objectMode || 0 !== t.length ? c(e, i, t, !1) : m(e, i))
												: c(e, i, t, !1);
									}
								}
								...
								if ((x('onEofChunk'), !t.ended)) {
									...
									(t.ended = !0),
										t.sync
											? _(e)
											: ((t.needReadable = !1),
											  !t.emittedReadable && ((t.emittedReadable = !0), h(e)));
								}
							}
							function _(e) {
								...
								x('emitReadable', t.needReadable, t.emittedReadable),
									(t.needReadable = !1),
									t.emittedReadable ||
										(x('emitReadable', t.flowing), (t.emittedReadable = !0), n.nextTick(h, e));
							}
							function h(e) {
								var t = e._readableState;
							...
							function y(e) {
								return function () {
									...
									x('pipeOnDrain', t.awaitDrain),
										...
										0 === t.awaitDrain && D(e, 'data') && ((t.flowing = !0), S(e));
								};
							}
							function C(e) {
								var t = e._readableState;
							...
							function v(e) {
								...
								x('endReadable', t.endEmitted),
									t.endEmitted || ((t.ended = !0), n.nextTick(k, t, e));
							}
							function k(e, t) {
								if (
							...
							Object.defineProperty(s.prototype, 'destroyed', {
								...
								(s.prototype.setEncoding = function (t) {
									...
									for (var r = this._readableState.buffer.head, a = ''; null !== r; )
										(a += n.write(r.data)), (r = r.next);
									return (
							...
							(s.prototype.read = function (e) {
								...
								if (
									...
									0 === e &&
										t.needReadable &&
										((0 === t.highWaterMark ? 0 < t.length : t.length >= t.highWaterMark) ||
											t.ended))
								)
									return (
										x('read: emitReadable', t.length, t.ended),
										0 === t.length && t.ended ? v(this) : _(this),
										null
									);
								...
								x('need readable', a),
									(0 === t.length || t.length - e < t.highWaterMark) &&
										((a = !0), x('length less than watermark', a)),
									t.ended || t.reading
										? ((a = !1), x('reading or ended', a))
										: a &&
										  (x('do read'),
										  (t.reading = !0),
										  (t.sync = !0),
								...
								return (
									...
									0 === t.length &&
										(!t.ended && (t.needReadable = !0), r !== e && t.ended && v(this)),
								...
								(s.prototype.pipe = function (e, t) {
									function r(e, t) {
										x('onunpipe'),
											e === p && t && !1 === t.hasUnpiped && ((t.hasUnpiped = !0), o());
									}
									function a() {
										x('onend'), e.end();
									}
									function o() {
										x('cleanup'),
											...
											p.removeListener('end', u),
											p.removeListener('data', d),
											(m = !0),
											f.awaitDrain && (!e._writableState || e._writableState.needDrain) && h();
									}
									function d(t) {
										x('ondata');
										var n = e.write(t);
										x('dest.write', n),
											!1 === n &&
												(((1 === f.pipesCount && f.pipes === e) ||
													(1 < f.pipesCount && -1 !== L(f.pipes, e))) &&
													!m &&
													(x('false write response, pause', f.awaitDrain), f.awaitDrain++),
												p.pause());
									}
									function s(t) {
										x('onerror', t),
									...
									return (
										...
										e.once('finish', c),
										e.emit('pipe', p),
										f.flowing || (x('pipe resume'), p.resume()),
										e
									);
								}),
								(s.prototype.unpipe = function (e) {
									...
									if (!e) {
										...
										for (var o = 0; o < a; o++) r[o].emit('unpipe', this, { hasUnpiped: !1 });
										return this;
									}
									var d = L(t.pipes, e);
									return -1 === d
								...
								(s.prototype.on = function (e, t) {
									...
									return (
										'data' === e
											? ((a.readableListening = 0 < this.listenerCount('readable')),
											...
											: 'readable' == e &&
											  ...
											  (a.flowing = !1),
											  (a.emittedReadable = !1),
											  x('on readable', a.length, a.reading),
											  a.length ? _(this) : !a.reading && n.nextTick(R, this)),
										r
									);
								}),
								...
								(s.prototype.resume = function () {
									...
									return (
										e.flowing || (x('resume'), (e.flowing = !e.readableListening), E(this, e)),
										(e.paused = !1),
										this
									);
								}),
								(s.prototype.pause = function () {
									return (
										...
										!1 !== this._readableState.flowing &&
											(x('pause'), (this._readableState.flowing = !1), this.emit('pause')),
						...
						(function () {
							...
							function s(t, n, r) {
								(k = k || e('./_stream_duplex')),
									(t = t || {}),
									'boolean' != typeof r && (r = n instanceof k),
									(this.objectMode = !!t.objectMode),
							...
							function u(e, t, r, a) {
								...
								return (
									null === r
										...
										: 'string' != typeof r &&
										  !t.objectMode &&
										  (o = new O('chunk', ['string', 'Buffer'], r)),
									!o || (Y(e, o), n.nextTick(a, o), !1)
								);
							}
							function p(e, t, n) {
								return (
								...
								--t.pendingcb,
									r
										? (n.nextTick(o, a),
										  ...
										  Y(e, a))
										: (o(a), (e._writableState.errorEmitted = !0), Y(e, a), S(e, t));
							}
							function h(e) {
							...
							function C(e, t) {
								...
								if (e._writev && n && n.next) {
									...
									for (; n; ) {
										...
										if (
											(g(e, t, !1, p, l, c, u), (n = n.next), t.bufferedRequestCount--, t.writing)
										)
											break;
									}
							...
							'function' == typeof Function.prototype[Symbol.hasInstance]
								? ((V = Function.prototype[Symbol.hasInstance]),
								  Object.defineProperty(l, Symbol.hasInstance, {
										value: function (e) {
											return (
												!!V.call(this, e) || (!(this !== l) && e && e._writableState instanceof s)
											);
										}
								  }))
								: (V = function (e) {
								...
								(l.prototype.write = function (e, t, n) {
									var r = this._writableState,
										...
										s = !r.objectMode && i(e);
									return (
										s && !x.isBuffer(e) && (e = o(e)),
										'function' == typeof t && ((n = t), (t = null)),
										s ? (t = 'buffer') : !t && (t = r.defaultEncoding),
										'function' != typeof n && (n = d),
										r.ending
											? c(this, n)
											: (s || u(this, r, e, n)) && (r.pendingcb++, (a = f(this, r, s, e, t, n))),
										a
									);
								}),
								...
								(l.prototype.destroy = D.destroy),
								(l.prototype._undestroy = D.undestroy),
							...
							t.exports = function (e) {
								var t,
									n = Object.create(
										...
										r(t, p, { value: null, writable: !0 }),
										r(t, f, { value: e._readableState.endEmitted, writable: !0 }),
										r(t, _, {
											value: function (e, t) {
												var r = n[h].read();
												r
													? ((n[g] = null), (n[c] = null), (n[u] = null), e(a(r, !1)))
													: ((n[c] = e), (n[u] = t));
											},
											writable: !0
										}),
								...
								return (
									...
									l(e, function (e) {
										if (e && 'ERR_STREAM_PREMATURE_CLOSE' !== e.code) {
											var t = n[u];
											return (
												null !== t && ((n[g] = null), (n[c] = null), (n[u] = null), t(e)),
												void (n[p] = e)
											);
										}
										var r = n[c];
										null !== r && ((n[g] = null), (n[c] = null), (n[u] = null), r(a(void 0, !0))),
											(n[f] = !0);
									}),
						...
						return (
							d(e, [
								...
								},
								{
									...
									value: function (e) {
										...
										for (var t = u.allocUnsafe(e >>> 0), n = this.head, r = 0; n; )
											s(n.data, t, r), (r += n.data.length), (n = n.next);
										return t;
									}
								},
								{
									...
									value: function (e) {
										...
										for (e -= a.length; (t = t.next); ) {
											...
											if (((a += i === o.length ? o : o.slice(0, e)), (e -= i), 0 === e)) {
												i === o.length
													? (++r, (this.head = t.next ? t.next : (this.tail = null)))
									...
									value: function (e) {
										...
										for (r.data.copy(t), e -= r.data.length; (r = r.next); ) {
											...
											if ((o.copy(t, t.length - e, 0, i), (e -= i), 0 === e)) {
												i === o.length
													? (++a, (this.head = r.next ? r.next : (this.tail = null)))
								...
								},
								{
									key: g,
									value: function (e, t) {
										return f(this, r({}, t, { depth: 0, customInspect: !1 }));
									}
								}
							]),
							e
												...
												: t &&
												  (this._writableState
														? !this._writableState.errorEmitted &&
														  ((this._writableState.errorEmitted = !0), e.nextTick(a, this, t))
														: e.nextTick(a, this, t)),
										  this)
												...
												!o && t
													? i._writableState
														? i._writableState.errorEmitted
															? e.nextTick(r, i)
															: ((i._writableState.errorEmitted = !0), e.nextTick(n, i, t))
														: e.nextTick(n, i, t)
													: o
													? (e.nextTick(r, i), o(t))
													: e.nextTick(r, i);
					...
					function o(e, t, d) {
						...
						var s = t.readable || (!1 !== t.readable && e.readable),
							...
							h = function () {
								var t;
								return s && !f
									? ((e._readableState && e._readableState.ended) || (t = new i()), d.call(e, t))
									: l && !u
									? ((e._writableState && e._writableState.ended) || (t = new i()), d.call(e, t))
									: void 0;
							},
							m = function () {
								e.req.on('finish', p);
						...
						return (
							a(e)
								? (e.on('complete', p), e.on('abort', h), e.req ? m() : e.on('request', m))
								: l && !e._writableState && (e.on('end', c), e.on('close', c)),
							e.on('end', g),
							e.on('finish', p),
							!1 !== t.error && e.on('error', _),
							e.on('close', h),
							function () {
				...
				function (e, t) {
					...
					function o(t, r, o, i) {
						...
						t.on('close', function () {
							...
							l === void 0 && (l = e('./end-of-stream')),
							l(t, { readable: r, writable: o }, function (e) {
				...
				function (e, t, n) {
					...
					function s(e, t, n) {
						...
						return 0 <= a
							...
							? 0
							: ((a = d(t[r])),
							  0 <= a ? (0 < a && (2 === a ? (a = 0) : (e.lastNeed = a - 3)), a) : 0);
					}
					function l(e, t) {
						...
						(o.prototype.fillLast = function (e) {
							return this.lastNeed <= e.length
								? (e.copy(this.lastChar, this.lastTotal - this.lastNeed, 0, this.lastNeed),
								  this.lastChar.toString(this.encoding, 0, this.lastTotal))
								: void (e.copy(this.lastChar, this.lastTotal - this.lastNeed, 0, e.length),
								  (this.lastNeed -= e.length));
						});
				},
				{ 'safe-buffer': 30 }
			...
			'/': [
				function (e, t) {
					...
					/*! simple-peer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */ const a =
							e('debug')('simple-peer'),
						o = e('get-browser-rtc'),
						i = e('randombytes'),
						d = e('readable-stream'),
					...
					class p extends d.Duplex {
						constructor(e) {
							if (
								...
								(this.channelName = e.initiator ? e.channelName || i(20).toString('hex') : null),
								(this.initiator = e.initiator || !1),
								(this.channelConfig = e.channelConfig || p.channelConfig),
								(this.channelNegotiated = this.channelConfig.negotiated),
								(this.config = Object.assign({}, p.config, e.config)),
								...
								(this._wrtc = e.wrtc && 'object' == typeof e.wrtc ? e.wrtc : o()),
								!this._wrtc)
							)
							...
							if (!this.destroying) {
								...
								this._debug('signal()'),
									...
									e.sdp ||
										...
										e.transceiverRequest ||
										this.destroy(
											l(new Error('signal() called with invalid signal data'), 'ERR_SIGNALING')
										);
							}
						}
						_addIceCandidate(e) {
						...
						_write(e, t, n) {
							if (this.destroyed)
								return n(l(new Error('cannot write after peer is destroyed'), 'ERR_DATA_CHANNEL'));
							if (this._connected) {
								try {
									this.send(e);
								} catch (e) {
							...
							this.destroyed ||
								this._pc
									...
									.then((e) => {
										...
										this.trickle || this.allowHalfTrickle || (e.sdp = n(e.sdp)),
						...
						_onConnectionStateChange() {
							this.destroyed ||
								('failed' === this._pc.connectionState &&
									this.destroy(l(new Error('Connection failed.'), 'ERR_CONNECTION_FAILURE')));
						}
						_onIceStateChange() {
							if (this.destroyed) return;
							...
							this._debug('iceStateChange (connection: %s) (gathering: %s)', e, t),
								...
								'failed' === e &&
									this.destroy(
										l(new Error('Ice connection failed.'), 'ERR_ICE_CONNECTION_FAILURE')
									),
								'closed' === e &&
									this.destroy(l(new Error('Ice connection closed.'), 'ERR_ICE_CONNECTION_CLOSED'));
						}
						getStats(e) {
							const t = (e) => (
								...
								this.destroyed ||
									this.getStats((t, n) => {
										...
										const d = (e) => {
											...
											t && (t.ip || t.address)
												? ((this.localAddress = t.ip || t.address), (this.localPort = +t.port))
												: t && t.ipAddress
												? ((this.localAddress = t.ipAddress), (this.localPort = +t.portNumber))
										...
										if (
											(n.forEach((e) => {
												'transport' === e.type &&
													...
													d(o[e.selectedCandidatePairId]),
													(('googCandidatePair' === e.type && 'true' === e.googActiveConnection) ||
														(('candidatepair' === e.type || 'candidate-pair' === e.type) &&
															e.selected)) &&
														d(e);
											}),
											!i && (!Object.keys(o).length || Object.keys(a).length))
										)
